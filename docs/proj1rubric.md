...
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code|3|[Video in README](https://github.com/CSC510-Group-5/URL-Shortner#url-shortner---simple-url-shortener)|
...
|Evidence that the whole team is using the same tools: everyone can get to all tools and files|3|VS Code Workspace file in repository|
...
|Evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)|3|VS Code Workspace file in repository|
